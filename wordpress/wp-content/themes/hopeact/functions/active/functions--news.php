 ...
 * Get Featured News
 **********************/
function hopeact_get_news_featured($category = null, $tags = null)
{
 ...
 * Get Related News
 **********************/
function hopeact_get_news_related($post_id)
{
    /**********************
     * QUERY POSTS
     ***********************/
 ...
 * Get News
 **********************/
add_action('wp_ajax_nopriv_ajax_posts', 'hopeact_get_news');
add_action('wp_ajax_ajax_posts', 'hopeact_get_news');
function hopeact_get_news($posts_per_page = 12, $template = 'card', $classes = [])
{
