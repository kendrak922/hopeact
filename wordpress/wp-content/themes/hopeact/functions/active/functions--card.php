 ...
 * @example
 * echo hopeact_postToCard($post_id);
 */

function hopeact_postToCard($post_id, $template = 'card')
{
    //image
    $size = 'medium';
 ...
 * @param array $post_id - pass the post id,  $template - alters card format if necessary
 * @example
 * echo hopeact_eventToCard($post_id);
 */

function hopeact_eventToCard($post_id, $template = 'card')
{
